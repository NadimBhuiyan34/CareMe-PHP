...
$query="INSERT INTO `tbluserregistration`( `fullName`, `emailid`, `mobileNumber`, `device`, `loginPassword`, `role`, `varification_code`, `is_varify`) VALUES ('$fname','$email','$mnumber','$device_id','$userpassword','$userpassword','$v_code','0')";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
            ...
            <form name="newtesting" method="post" action="send.php">
                     <div class="row">
